...
description: >-
  Opinionated best practices and conventions for building production FastAPI
  apps, mirrored exactly from https://github.com/zhanymkanov/fastapi-best-practices.
  Covers project structure, async vs sync routes, Pydantic usage, dependency
  injection patterns, DB/Alembic conventions, testing, and more. Use whenever
  the user is building, structuring, reviewing, or debugging a FastAPI project
  -- e.g. "how should I structure this FastAPI app", "is this the right way to
  use Depends", "should this route be async", "set up Alembic migrations",
  "write async tests for FastAPI" -- even if they don't say "best practices"
  explicitly.
---
...
> **Working with an AI agent?** See [AGENTS.md](references/AGENTS.md) for the same rules in a
